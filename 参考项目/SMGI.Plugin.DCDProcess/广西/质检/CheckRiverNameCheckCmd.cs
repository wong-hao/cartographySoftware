            ...
            try
            {
                ...
                foreach (var kv in gbsDic)
                {
                    ...
                    while ((fe = cursor.NextFeature()) != null)
                    {
                        ...
                        sf.Geometry = py;
                        sf.WhereClause = "GB in (210101,220201,220301,220202,220302) and name is not null ";//2020-10-21按张宇要求检查有名称HYDA水系面gb=210101、220201、220301、220202、220302
                        ...
                        while ((f = fcursor.NextFeature()) != null)
                        {
                            ...
                            if (retopo.Contains(py))//水系结构线在水系面内,也分水系面的结构线和外部河流流入水系面的连接式结构线
                            {
                                if (py.Length > len)
                                {
                                    ...
                                    if (name1 != name)
                                    {
                                        errsDic[fe.OID] = "HYDL:" + fe.OID + "与HYDA：" + f.OID + "不一致";
                                    }
                                }
                                else
                                {
