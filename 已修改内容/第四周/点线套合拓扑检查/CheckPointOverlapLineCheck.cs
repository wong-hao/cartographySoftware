...
{
    public static class CheckPointOverlapLineCheck
    {
        ...
        public static ResultMessage Check(IFeatureWorkspace featureWorkspace, List<Tuple<string, string, string, string, string>> tts, Progress progWindow=null)
        {
            ...
            foreach (var tt in tts)
            {
                ...
                try
                {
                    ...
                    {
                        ptQF.WhereClause = cmdUpdateRecord.CurFeatureFilter;
                    }
                    else
                    {
                        ptQF.WhereClause = ptSQL + " and " + cmdUpdateRecord.CurFeatureFilter;
                    }
                    ...
                    while ((ptCheckFeature = ptFeatureCursor.NextFeature()) != null)
                    {
                        ...
                        {
                            pFilter.WhereClause = plSQL + " and " + cmdUpdateRecord.CurFeatureFilter;
                        }
        ...
        public static ResultMessage SaveResult(string dir,  bool autoOver = false, bool toGdb = false)
        {
            ...
            {
                //保存txt文件
                string txtFile = dir + "\\点线套合拓扑检查.txt";
                ...
                string shpFile = shpdir + "\\点线套合拓扑检查";
