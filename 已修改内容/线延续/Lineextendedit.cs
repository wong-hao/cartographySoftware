...
namespace SMGI.Plugin.CollaborativeWorkWithAccount
{
    ...
    {   
        ...
        public override void OnDblClick()
        {
            ...
            //删除状态的要素不参与
            int versionIndex = selFeature.Fields.FindField(ServerDataInitializeCommand
                .CollabVERSION);
            int delIndex = selFeature.Fields.FindField(ServerDataInitializeCommand
                .CollabDELSTATE);
            if (versionIndex != -1 && delIndex != -1)
            {
                ...
                if (ver < 0 && delState == ServerDataInitializeCommand
                        .DelStateText)
                {
