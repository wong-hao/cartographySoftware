...
namespace SMGI.Plugin.DCDProcess
{
    public class TopoPointRelationHNcmd : SMGI.Common.SMGICommand
    {
        ...
        public override void OnClick()
        {
            ...
            {
                //保存质检结果
                resultMessage = TopoPointRelationHNCheck.SaveResult(OutputSetup.GetDir());
                if (resultMessage.stat != ResultState.Ok)
                {
                    MessageBox.Show(resultMessage.msg);
                    return;
            ...
            TopoPointRelationHNCheck.Clear();
