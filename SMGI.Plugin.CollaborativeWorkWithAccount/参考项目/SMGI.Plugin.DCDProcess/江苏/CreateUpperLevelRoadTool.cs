...
namespace SMGI.Plugin.DCDProcess
{
    ...
    /// 生成上层路
    /// </summary>
    public class CreateUpperLevelRoadTool : SMGITool
    {
        private IFeatureLayer _lrdlLayer;
        private IFeatureLayer _lralLayer;

        public CreateUpperLevelRoadTool()
        {
            m_category = "生成上层路";
            m_caption = "生成上层路";
        }
        ...
        public override void OnMouseDown(int button, int shift, int x, int y)
        {
            ...
            if (frm.InterFeature != null)
            {
                ...
                try
                {
                    ...
                    m_Application.EngineEditor.StopOperation("生成上层路");
                }
                catch (Exception ex)
                {
    ...
    public class InterFeatureWarp
    {
        public InterFeatureWarp(IFeature f, IPolyline interGeo)
        {
            Feature = f;
            InterPolyline = interGeo;
        }

        public IFeature Feature { get; set; }
        public IPolyline InterPolyline { get; set; }
